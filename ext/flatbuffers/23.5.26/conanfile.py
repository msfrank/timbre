...
FLATBUFFERS_URL = "https://github.com/bexcite/flatbuffers/archive/refs/heads/pb/fix-rare-fix.tar.gz"
FLATBUFFERS_DOWNLOAD_NAME = "flatbuffers-pb-fix-rare-fix.tar.gz"
FLATBUFFERS_SOURCE_DIR = "flatbuffers-pb-fix-rare-fix"
