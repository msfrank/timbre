...
ANTLR_COMPLETE_JAR_URL = "https://repo1.maven.org/maven2/org/antlr/antlr4/4.9.3/antlr4-4.9.3-complete.jar"
ANTLR_COMPLETE_JAR_DOWNLOAD_NAME = "antlr-4.9.3-complete.jar"
ANTLR_RUNTIME_URL = "https://github.com/antlr/antlr4/archive/4.9.3.tar.gz"
ANTLR_RUNTIME_DOWNLOAD_NAME = "antlr4-4.9.3.tar.gz"
ANTLR_RUNTIME_SOURCE_DIR = "antlr4-4.9.3"
