...
ARROW_URL = "https://github.com/apache/arrow/archive/refs/tags/apache-arrow-16.0.0.tar.gz"
ARROW_DOWNLOAD_NAME = "arrow-apache-arrow-16.0.0.tar.gz"
ARROW_SOURCE_DIR = "arrow-apache-arrow-16.0.0"
...
"""
    ...
    def requirements(self):
        ...
        self.requires("rapidjson/20230820.1@timbre")
    ...
    def generate(self):
        ...
        #tc.cache_variables['BOOST_ROOT'] = self.dependencies["boost"].package_folder
